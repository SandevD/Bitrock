...
<div class="container new_login" style="display: flex; align-items: center; justify-content: center; height: 100vh;">
    <form class="new_login_form" action="{{ route('login') }}" method="POST">
        @csrf
        <div class="row">
        ...
        <div class="row">
            <div class="col">
                <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="floatingInput" placeholder="" name="email" size="30">
        ...
        <div class="row">
            <div class="col">
                <div align="center">
                    <a class="btn btn-block p-1" href="{{ route('welcome.index') }}">Home</a>
                    <!--<a class="btn btn-block p-1" href="{{ route('changepassword') }}">Reset</a>-->
                    <button type="submit" class="btn btn-block p-1">{{ __('Login') }}</button>
                </div>
            </div>
        </div>
    </form>
