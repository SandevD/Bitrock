<button type="button" class="btn scrollbtn btn-danger btn-floating btn-lg material-symbols-outlined" id="btn-back-to-top">
    keyboard_double_arrow_up
</button>
<!-- Sidebar-->
<div class="border-end" style="background-color: #d3d3d3;" id="sidebar-wrapper">
    <div class="sidebar-heading border-bottom bg-dark">
        <svg id="bitsvg" class="pb-2" width="180px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 483 86"
            style="enable-background:new 0 0 483 86;" xml:space="preserve">
            <style type="text/css">
                .st0 {
                    fill: #fff;
                }
            ...
            <path class="st0"
                d="M153.01,43.88c9.05,5.27,9.8,15.96,6.64,22.66c-1.92,4.08-5.33,6.6-9.43,8.24c-3.82,1.53-7.82,2.3-11.9,2.34
        ...
        z" />
            <path class="st1"
                d="M300.7,77.05c-0.25,0.11-0.51,0.19-0.77,0.19c-3.92,0.01-7.84-0.01-11.76,0.02c-0.6,0-0.93-0.22-1.25-0.69
        ...
        C255.82,23.24,255.82,25.99,255.82,28.93z" />
            <path class="st2"
                d="M82.67,40.1c0.09,2.09,0.18,4.11,0.23,6.12c0.02,0.73-0.39,1.1-1.16,1.1c-5.11-0.01-10.23,0.01-15.34-0.03
        ...
        c10,9.83,19.99,19.67,29.99,29.5c3.12,3.07,6.25,6.14,9.36,9.21C82.17,39.47,82.4,39.75,82.67,40.1z" />
            <path class="st2"
                d="M70.49,85.43c-1.62-0.01-3.32,0.39-4.63-0.15c-1.31-0.54-2.25-2.01-3.33-3.08c-6.8-6.75-13.6-13.5-20.4-20.26
        ...
        c0.02,0.81-0.39,1.11-1.2,1.11C77.99,85.42,74.29,85.43,70.49,85.43z" />
            <path class="st0"
                d="M353.18,27.07c5.59,4.24,9.17,9.74,10.45,16.56c2.93,15.63-5.6,29.2-20.26,33.1
        ...
        C329.61,28.73,319.64,32.61,316.09,43.04z" />
            <path class="st0"
                d="M466.21,38.18c-2.66,2.83-5.27,5.62-7.92,8.44c8.18,10.15,16.32,20.26,24.59,30.51c-2.28,0-4.38,0-6.47,0
        ...
        c0.26,0,0.53,0,1.01,0C476.29,27.45,471.27,32.79,466.21,38.18z" />
            <path class="st0"
                d="M403.91,30.31c-6.81-0.69-12.81,0.88-17.53,5.95c-3.38,3.62-4.87,8.05-4.89,12.98
        ...
        C412.67,33.09,408.73,30.94,403.91,30.31z" />
            <path class="st3"
                d="M223.9,20.57c4.89,0,9.69,0,14.54,0c0,2.96,0,5.85,0,8.83c-6.17,0-12.34,0-18.57,0c0,15.85,0,31.6,0,47.42
        ...
        " />
            <path class="st4"
                d="M172.29,38.39c0-5.96,0-11.84,0-17.77c3.48,0,6.92,0,10.42,0c0,18.7,0,37.42,0,56.2c-3.42,0-6.86,0-10.42,0
        C172.29,64.04,172.29,51.26,172.29,38.39z" />
        </svg>
    </div>

    <div class="list-group list-group-flush">
        <a class="list-group-item list-group-item-action list-group-item-dark p-3 {{ menuActive('admin.index') }}"
            href="{{ route('admin.index') }}">Dashboard</a>
        <a class="list-group-item list-group-item-action list-group-item-dark p-3 {{ menuActive('about.index') }}"
            href="{{ route('about.index') }}">About Us</a>
    </div>
    <div class="list-group list-group-flush">
        <a class="list-group-item list-group-item-action list-group-item-dark p-3 {{ menuActive('portfolio.index') }}"
            href="{{ route('portfolio.index') }}">Portfolio</a>
        <a class="list-group-item list-group-item-action list-group-item-dark p-3 {{ menuActive('whyus.index') }}"
            href="{{ route('whyus.index') }}">Why Us</a>
    </div>
    <div class="list-group list-group-flush">
        <a class="list-group-item list-group-item-action list-group-item-dark p-3 {{ menuActive('contactus.index') }}"
            href="{{ route('contactus.index') }}">Contact Us</a>
        <a class="list-group-item list-group-item-action list-group-item-dark p-3 {{ menuActive('footer.index') }}"
            href="{{ route('footer.index') }}">Footer</a>
    </div>

    <div class="list-group list-group-flush">
        <a class="list-group-item list-group-item-action list-group-item-dark p-3 {{ menuActive('document.index') }}"
            href="{{ route('document.index') }}">Documents</a>
    </div>
    <div class="list-group list-group-flush">
        <a class="list-group-item list-group-item-action list-group-item-dark p-3 {{ menuActive('subscribers.show') }}"
            href="{{ route('subscribers.show') }}">Subscribers</a>
        <a class="list-group-item list-group-item-action list-group-item-dark p-3 {{ menuActive('unsubscribes.show') }}"
            href="{{ route('unsubscribes.show') }}">Unscribe Requests</a>
    </div>
</div>
